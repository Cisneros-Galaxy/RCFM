...
class Neros:
    ...
    def vNeros(self, galaxy_rad, galaxy_vLum, alpha, phi_zero=MW_phi[-1]):
        ...
        return np.sqrt(self.vNerosSquared(galaxy_rad, galaxy_vLum, alpha, phi_zero=MW_phi[-1]))
        
    def vNerosSquared(self, galaxy_rad, galaxy_vLum, alpha, MW_phi, phi_zero= MW_phi[-1]):
    ...
    def vLCM(self, galaxy_rad, galaxy_vLum, MW_phi, phi_zero= MW_phi[-1]):
        ...
        :galaxy_vLum: A 1-D NumPy array or Pandas DataSeries of vLums
        :
        : The zero point for the phi integration, used in kappa calculation"""
    ...
    def kappa(self, MW_phi, other_phi, phi_zero= MW_phi[-1]):
